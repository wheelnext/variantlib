...
def test_null_variant() -> None:
    ...
    assert vdesc.hexdigest == hashlib.sha256(b"").hexdigest()[:VARIANT_LABEL_LENGTH]
...
def test_variantdescription_hexdigest() -> None:
    ...
    expected_hexdigest = hash_object.hexdigest()[:VARIANT_LABEL_LENGTH]
...
def test_variantdescription_deserialization() -> None:
    ...
    assert vdesc.hexdigest == "c44d3adffe3fcb5d"
...
def test_random_hexdigest(vdesc: VariantDescription) -> None:
    ...
    assert len(vdesc.hexdigest) == VARIANT_LABEL_LENGTH
