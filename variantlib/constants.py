...
PYPROJECT_TOML_PROVIDER_ENABLE_IF_KEY = "enable-if"
...
VARIANTS_JSON_PROVIDER_ENABLE_IF_KEY = PYPROJECT_TOML_PROVIDER_ENABLE_IF_KEY
...
VALIDATION_PLUGIN_VALUE_REGEX = re.compile(r"[a-z0-9_.]+")
