...
VARIANTS_JSON_DEFAULT_PRIO_NAMESPACE_KEY = f"default-{PYPROJECT_TOML_NAMESPACE_KEY}-priorities"  # noqa: E501
VARIANTS_JSON_DEFAULT_PRIO_FEATURE_KEY = f"default-{PYPROJECT_TOML_FEATURE_KEY}-priorities"  # noqa: E501
VARIANTS_JSON_DEFAULT_PRIO_PROPERTY_KEY = f"default-{PYPROJECT_TOML_PROPERTY_KEY}-priorities"  # noqa: E501
...
METADATA_VARIANT_DEFAULT_PRIO_NAMESPACE_HEADER = f"Variant-{VARIANTS_JSON_DEFAULT_PRIO_NAMESPACE_KEY}"  # noqa: E501
METADATA_VARIANT_DEFAULT_PRIO_FEATURE_HEADER = f"Variant-{VARIANTS_JSON_DEFAULT_PRIO_FEATURE_KEY}"  # noqa: E501
METADATA_VARIANT_DEFAULT_PRIO_PROPERTY_HEADER = f"Variant-{VARIANTS_JSON_DEFAULT_PRIO_PROPERTY_KEY}"  # noqa: E501
# fmt: on
